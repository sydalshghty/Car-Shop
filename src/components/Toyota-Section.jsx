...
function ToyotaDepartament() {
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsMobile(window.innerWidth <= 768 ); // لو الشاشة أقل من أو = 992px
    };
    handleResize();
  ...
  return (
    <div
      className="Toyota-departament w-full h-full pt-10 pb-10"
      id="Toyota-departament"
    >
      <div className="container text-end w-full">
        <div className="col-heading flex w-full items-end justify-end">
          <div className="col w-6 h-12 rounded bg-mainColor"></div>
          ...
          {CarToyota.length === 0 ? (
            ...
            <div className="all-cars-content w-full overflow-hidden">
              {!isMobile ? (
                  ...
                  {CarToyota.map((product) => (
                    <div className="content-car" key={product.id}>
                        ...
                        <div className="content-prices">
                          <div className="old-price flex items-center">
                            <div className="flex gap-1 items-center">
                              ...
                              <p className="text-lg text-mainColor font-semibold p-old">
                                {product.oldprice}
                              </p>
                            </div>
                            <p>(شامل الضريبة)</p>
                      ...
                      <div className="contact-whatsap w-full h-16 bg-whattsappcolor flex justify-center items-center gap-4 cursor-pointer">
                        ...
                        <a href="#Whatsapp" className="text-lg text-white">
                          واتساب
                        </a>
                      </div>
                    </div>
                ...
                // هنا المنتجات هتظهر تحت بعض عادي
        ...
        <div className="col-btn mt-16 flex justify-center items-center">
          <button className="w-52 h-16 bg-mainColor rounded-lg text-white text-lg border-none outline-none">
            عرض المزيد
          </button>
        </div>
      </div>
